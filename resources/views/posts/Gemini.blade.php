...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <x-app-layout> 
     <body>
        <h1>Geminiの回答</h1>
      <div style="white-space: pre-line; color:blue"> {{$response}}</div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?language=ja&region=JP&key=AIzaSyD3gLab1CM_8HW3hKt-cgazQIXtvdBUyvI&callback=initMap" async defer></script>
